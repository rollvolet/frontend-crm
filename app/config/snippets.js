export default {
  NED: {
    offerDocumentIntro:
      '<p class="aanhef">Geachte heer, mevrouw,</p><div>Met genoegen bezorgen wij u onze beste prijs voor:</div>',
    offerDocumentOutro:
      '<p>Deze offerte is 30 dagen geldig.</p><div>Indien u akkoord gaat met deze offerte vragen wij u vriendelijk ons dit schriftelijk te bevestigen, via email of per post. Wij bezorgen u daarna een voorschotfactuur van 30% van het totale bedrag.<p>Door goedkeuring van deze offerte verklaart u zich akkoord met de bijgevoegde algemene voorwaarden.</p></div>',
  },
  FRA: {
