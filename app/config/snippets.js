export default {
  ...
  FRA: {
    ...
    offerDocumentOutro: `<p>Cette offre est valable pendant 30 jours.</p><br><div>Si vous êtes d'accord, veuillez nous envoyer votre confirmation par écrit. Vous recevrez ensuite une facture d'acompte de 30% du montant total. En acceptant cette offre, vous confirmez votre accord avec nos conditions g&eacute;n&eacute;rales de vente ci-jointes.</div><br><div>Dans l'attente du plaisir de lire votre accord, nous vous prions d'agréer nos salutations distinguées.</div>`,
  },
};
